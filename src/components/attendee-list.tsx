  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <Table>
          ...
          {Array.from({ length: 8 }).map((_, i) => {
            return (
              <TableRow key={i}>
                ...
                <TableCell>7 dais atrás</TableCell>
                <TableCell>3 dais atrás</TableCell>
                <TableCell>
        ...
        <tfoot>
          <tr>
            <TableCell colSpan={3}>Mostrando 10 de 228 participantes</TableCell>
